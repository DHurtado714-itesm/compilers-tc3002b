  ...
  def eval(self, env, aTurtle):
    ...
    if red < 0 or red > 255:
      text = (
        "Line "
        + self.line
        + "expected a positive number between 0..255 in the red value."
      )
      raise Exception(text)
    ...
    if green < 0 or green > 255:
      text = (
        "Line "
        + self.line
        + "expected a positive number between 0..255 in the blue value."
      )
      raise Exception(text)
    ...
    if blue < 0 or blue > 255:
      text = (
        "Line "
        + self.line
        + "expected a positive number between 0..255 in the green value."
      )
      raise Exception(text)
